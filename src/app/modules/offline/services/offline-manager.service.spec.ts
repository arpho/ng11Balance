...
describe('OfflineManagerService', () => {
  ...
  it('status should be 0', () => {
    const service = new CategoriesService(new OfflineManagerService(new OfflineDbService()), new UsersService())
  ...
  it('status should be 1', () => {
    ...
    OfflineManagerService.servicesList.push(new CategoriesService(new OfflineManagerService(new OfflineDbService()), new UsersService()).setOfflineStatus(1))
    OfflineManagerService.servicesList.push(new CategoriesService(new OfflineManagerService(new OfflineDbService()), new UsersService()).setOfflineStatus(1))
  ...
  it('status should be 2', () => {
    OfflineManagerService.servicesList.push(new CategoriesService(new OfflineManagerService(new OfflineDbService()), new UsersService()).setOfflineStatus(1))
    OfflineManagerService.servicesList.push(new CategoriesService(new OfflineManagerService(new OfflineDbService()), new UsersService()).setOfflineStatus(2))
    OfflineManagerService.servicesList.push(new CategoriesService(new OfflineManagerService(new OfflineDbService()), new UsersService()).setOfflineStatus(1))
    OfflineManagerService.servicesList.push(new CategoriesService(new OfflineManagerService(new OfflineDbService()), new UsersService()).setOfflineStatus(2))
